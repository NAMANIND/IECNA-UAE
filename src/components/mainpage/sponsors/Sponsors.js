...
function Sponsors() {
  return (
    <div
      className="flex flex-col justify-center px-20 pt-32 pb-20 text-5xl text-center text-black bg-white whitespace-nowrap leading-[61.92px] w-full max-md:text-4xl"
    ...
    >
      ...
      <img
        ...
        className="mt-20 w-[80%] aspect-[4.76] max-md:mt-10 max-md:max-w-full"
      />
    </div>
  );
}
